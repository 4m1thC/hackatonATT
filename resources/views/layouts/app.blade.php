            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('expositores.index') }}">{{ __('Expositores') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('certificados.index') }}">{{ __('Certificados') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('inscribe-usuario-eventos.index') }}">{{ __('Inscribe') }}</a>
                        </li> 
